...
from .views import (
    ...
    RegisterView, IncidentStatisticsView, SecurityEffectivenessView,
    PostgresDBManagementView
)
...
urlpatterns = [
    ...
    path('security-effectiveness/', SecurityEffectivenessView.as_view(), name='security-effectiveness'),
